...
class GameEngine {
	...
	private function init_hooks() {
		add_action( 'wp_ajax_ea_gaming_start_session', [ $this, 'ajax_start_session' ] );
		add_action( 'wp_ajax_ea_gaming_end_session', [ $this, 'ajax_end_session' ] );
		add_action( 'wp_ajax_ea_gaming_update_session', [ $this, 'ajax_update_session' ] );
	}
	 ...
	 * @return bool
	 */
	public function end_session( $session_id, $stats = [] ) {
		global $wpdb;
